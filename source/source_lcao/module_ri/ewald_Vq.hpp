                 ...
                 std::map<TA, std::map<TAC, RI::Tensor<Tdata>>>>
{
    ...
    ModuleBase::timer::start("Ewald_Vq", "cal_Vs_split");
...
#pragma omp critical(Ewald_Vq_cal_Vs_split)
    ...
    ModuleBase::timer::end("Ewald_Vq", "cal_Vs_split");
    ...
    -> std::map<TA, std::map<TAC, RI::Tensor<Tdata>>>
{
    ...
    ModuleBase::timer::start("Ewald_Vq", "cal_short_range_Vs");
    ...
    ModuleBase::timer::end("Ewald_Vq", "cal_short_range_Vs");
    return Vs_short;
}
    ...
    -> std::map<TA, std::map<TAC, RI::Tensor<Tdata>>>
{
    ...
    ModuleBase::timer::start("Ewald_Vq", "cal_long_range_Vs_gauss");
...
#pragma omp critical(Ewald_Vq_cal_long_range_Vs_gauss)
    ...
    ModuleBase::timer::end("Ewald_Vq", "cal_long_range_Vs_gauss");
    return Vs_long;
}
